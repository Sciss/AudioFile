...
import de.sciss.synth.io.IndexedDBAsyncChannel
import de.sciss.synth.io.IndexedDBAsyncChannel.{mkException, mkStoreName}
...
private[io] final class IndexedDBAsyncChannelImpl(db: IDBDatabase, path: String, blockSize: Int, val size: Long)
